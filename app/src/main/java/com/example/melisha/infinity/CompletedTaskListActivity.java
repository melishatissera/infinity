...
public class CompletedTaskListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CompletedTaskListActivity.this));
        progressDialog = new ProgressDialog(CompletedTaskListActivity.this);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot snapshot, String s) {
                ...
                adapter = new ListingAdapter(CompletedTaskListActivity.this, list);
