...
public class CompletedTaskListMangerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_task_list_manger);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CompletedTaskListMangerActivity.this));
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot snapshot, String s) {
                ...
                adapter = new ListingAdapter(CompletedTaskListMangerActivity.this, list);
