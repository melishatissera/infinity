...
public class OnGoingMangerTaskListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_going_manger_task_list);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(OnGoingMangerTaskListActivity.this));
        progressDialog = new ProgressDialog(OnGoingMangerTaskListActivity.this);
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        query = FirebaseDatabase.getInstance().getReference().child("tasks").orderByChild("taskStatus").equalTo("onGoing");
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot snapshot, String s) {
                ...
                adapter = new ListingAdapter(OnGoingMangerTaskListActivity.this, list);
