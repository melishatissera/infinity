...
public class ViewAssignTaskListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ViewAssignTaskListActivity.this));
        progressDialog = new ProgressDialog(ViewAssignTaskListActivity.this);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot snapshot, String s) {
                ...
                adapter = new ListingAdapter(ViewAssignTaskListActivity.this, list);
