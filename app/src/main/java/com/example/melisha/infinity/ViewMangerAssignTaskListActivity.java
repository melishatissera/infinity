...
public class ViewMangerAssignTaskListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ViewMangerAssignTaskListActivity.this));
        progressDialog = new ProgressDialog(ViewMangerAssignTaskListActivity.this);
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        query = FirebaseDatabase.getInstance().getReference().child("tasks").orderByChild("taskAssignee");
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot snapshot, String s) {
                ...
                adapter = new ListingAdapter(ViewMangerAssignTaskListActivity.this, list);
