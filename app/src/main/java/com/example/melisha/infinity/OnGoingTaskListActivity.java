...
public class OnGoingTaskListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_going_task_list);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(OnGoingTaskListActivity.this));
        progressDialog = new ProgressDialog(OnGoingTaskListActivity.this);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot snapshot, String s) {
                ...
                adapter = new ListingAdapter(OnGoingTaskListActivity.this, list);
